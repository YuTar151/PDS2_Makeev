...
def function(a):
    ...
    if a != number and a > number:
        print(f"Ні, не вгадав. Загадане число меньше {a}.")
        tryes -= 1
        if tryes != 0:
            a = int(input("Ще одна спроба: "))
            function(a)
        else:
            print(f"На жаль ти використав всі спроби. Загадане число було {number}. Спробуй наступного разу.")

    elif a != number and a < number:
        print(f"Ні, не вгадав. Загадане число більше {a}.")
        tryes -= 1
        if tryes != 0:
            a = int(input("Ще одна спроба: "))
            function(a)
...
tryes = 6
a = int(input("Добре, у тебе є 6 спроб. Вгадай яке число я загадав від 0 до 100: "))
